...
public:
	virtual bool Load()
	{
		...
		light::ScopeProfiler profiler(__FUNCTIONW__, 10, _T("./XML/Character.XML"));
		if( false == parser.read_file(_T("./XML/Character.XML")))
		{
		...
		if ( false == parser.bind_attrib(_T("Action_Cooltime"), Instance.Action_CooltimeReference()))
		{
			LOG_ERROR(_T("%s, bind_attrib() Failed. Instance.Action_CooltimeReference()"), __FUNCTIONW__);
			return false;
		}

		if ( false == parser.bind_attrib(_T("Agi"), Instance.AgiReference()))
		{
			LOG_ERROR(_T("%s, bind_attrib() Failed. Instance.AgiReference()"), __FUNCTIONW__);
			return false;
		}

		if ( false == parser.bind_attrib(_T("Cost"), Instance.CostReference()))
		{
			LOG_ERROR(_T("%s, bind_attrib() Failed. Instance.CostReference()"), __FUNCTIONW__);
			return false;
		}

		if ( false == parser.bind_attrib(_T("Decide"), Instance.DecideReference()))
		{
			LOG_ERROR(_T("%s, bind_attrib() Failed. Instance.DecideReference()"), __FUNCTIONW__);
			return false;
		}

		if ( false == parser.bind_attrib(_T("Decide_Cooltime"), Instance.Decide_CooltimeReference()))
		{
			LOG_ERROR(_T("%s, bind_attrib() Failed. Instance.Decide_CooltimeReference()"), __FUNCTIONW__);
			return false;
		}

		if ( false == parser.bind_attrib(_T("Dex"), Instance.DexReference()))
		{
			LOG_ERROR(_T("%s, bind_attrib() Failed. Instance.DexReference()"), __FUNCTIONW__);
			return false;
		}

		if ( false == parser.bind_attrib(_T("Image"), Instance.ImageReference()))
		{
		...
		if ( false == parser.bind_attrib(_T("Int"), Instance.IntReference()))
		{
			LOG_ERROR(_T("%s, bind_attrib() Failed. Instance.IntReference()"), __FUNCTIONW__);
			return false;
		}

		if ( false == parser.bind_attrib(_T("Luck"), Instance.LuckReference()))
		{
			LOG_ERROR(_T("%s, bind_attrib() Failed. Instance.LuckReference()"), __FUNCTIONW__);
			return false;
		}
		...
		if ( false == parser.bind_attrib(_T("Phy"), Instance.PhyReference()))
		{
			LOG_ERROR(_T("%s, bind_attrib() Failed. Instance.PhyReference()"), __FUNCTIONW__);
			return false;
		}

		if ( false == parser.bind_attrib(_T("Sight"), Instance.SightReference()))
		{
			LOG_ERROR(_T("%s, bind_attrib() Failed. Instance.SightReference()"), __FUNCTIONW__);
			return false;
		}

		if ( false == parser.bind_attrib(_T("Speed"), Instance.SpeedReference()))
		{
			LOG_ERROR(_T("%s, bind_attrib() Failed. Instance.SpeedReference()"), __FUNCTIONW__);
			return false;
		}

		if ( false == parser.bind_attrib(_T("Str"), Instance.StrReference()))
		{
			LOG_ERROR(_T("%s, bind_attrib() Failed. Instance.StrReference()"), __FUNCTIONW__);
			return false;
		}

		if ( false == parser.bind_attrib(_T("Wis"), Instance.WisReference()))
		{
